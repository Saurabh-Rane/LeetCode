...
<p>The distance between two points on the <strong>X-Y</strong> plane is the Euclidean distance (i.e., <code>√(x<sub>1</sub> - x<sub>2</sub>)<sup style="">2</sup> + (y<sub>1</sub> - y<sub>2</sub>)<sup style="">2</sup></code>).</p>
...
<ul data-read-aloud-multi-block="true">
	<li><code>1 &lt;= k &lt;= points.length &lt;= 10<sup style="">4</sup></code></li>
